...
<x-guest-layout>
    <div class="flex flex-col md:flex-row"> {{-- Konten dua kolom di dalam kartu guest-layout --}}
        ...
        <div class="w-full md:w-1/2 bg-white flex flex-col justify-center items-center p-8 sm:p-12 dark:bg-gray-800">
            <div class="w-full max-w-md">
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="mb-6" x-data="{ showPassword: false }">
                        <div class="relative">
                            ...
                            <div class="absolute inset-y-0 end-0 flex items-center pe-3.5">
                                <button type="button" @click="showPassword = !showPassword" class="text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none">
                                    <svg x-show="!showPassword" class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 0 1 0-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178Z" />
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                                    </svg>
                                    <svg x-show="showPassword" style="display: none;" class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                    ...
                    <p class="text-sm text-center text-medium-gray dark:text-gray-400">
                        Belum punya akun?
        ...
        <div class="hidden md:flex w-full md:w-1/2 bg-primary flex-col justify-center items-center p-12 text-white relative">
            <img src="{{ asset('images/reporter.svg') }}" {{-- Pastikan path ini benar --}}
                 alt="Ilustrasi RadarNews" class="max-w-xs lg:max-w-sm xl:max-w-md">
        </div>
    </div>
</x-guest-layout>
